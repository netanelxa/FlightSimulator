...
*/
bool LoopCommand::isInMap(int currentPlace) {
 ...
 * @param currentPlace is the index of the current command
*/
void LoopCommand::updateCondition(int currentPlace) {
...
*/
bool LoopCommand::isCondition(int val1, int val2, string oper) {
 ...
 * @param currentPlace is the index of the current command
*/
void LoopCommand::UpdateVarible(int currentPlace) {
...
*/
void LoopCommand::UpdateVarible(int currentPlace, Expression *e) {
    this->socket = sockets.top();
    for (pair<string, VarObj *> it:fromSim_map) {
        if (it.first == arrayofString[currentPlace]) {
...
*/
int LoopCommand::execute(int currentPlace) {
